...
export function FeedbackModal({ isOpen, feedback, onClose, onNext }: FeedbackModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md w-full mx-4" data-testid="feedback-modal">
        {feedback.correct ? (
          <div className="text-center">
            ...
            <DialogHeader>
              <DialogTitle className="text-xl font-semibold text-secondary" data-testid="feedback-title-correct">
                Richtig!
              </DialogTitle>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4 mt-4">
              <p className="text-sm text-gray-700" data-testid="feedback-explanation">
          ...
          <div className="text-center">
            ...
            <DialogHeader>
              <DialogTitle className="text-xl font-semibold text-red-600" data-testid="feedback-title-incorrect">
                Nicht ganz richtig
              </DialogTitle>
              <DialogDescription className="text-gray-600 mt-2">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
              ...
              <p className="text-sm text-blue-700" data-testid="feedback-explanation">
                {feedback.explanation}
              </p>
            </div>
